...
const ProductosPage = () => {
  ...
  return (
    <div
      className={`flex justify-center flex-row p-10 max-sm:p-5 text-center h-full ${
        theme ? "light-theme" : "dark-theme"
      }`}
    >
      <div className="flex">
        <button
          className={`text-black h-[53px] w-[55px] rounded-4xl relative left-209 max-sm:left-80 max-sm:w-[40px] max-sm:h-[41px] transition duration-300 ease-in-out ${
            theme
